...
function ChartTimeSalaryPage() {
    const [datacharttimesalary, setDataChartTimeSalary] = useState([])
    const loadTimeSalary = () => {
        setDataChartTimeSalary([
            {
                name: 'Total Minutes',
        ...
        <Space direction='vertical' className='w-100' size='small'>
            <Row>
                ...
                <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={24} className='mt-4'>
                    <ChartTimeSalary data={datacharttimesalary} />
                </Col>
            </Row>
        </Space>
    )
...
export default ChartTimeSalaryPage
