...
function ChartOverTimePage() {
    const [datachartovertime, setDataChartOverTime] = useState([])
    const loadOverTime = () => {
        setDataChartOverTime([
            {
                name: 'Normal Night',
        ...
        <Space direction='vertical' className='w-100' size='small'>
            <Row>
                ...
                <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={24} className='mt-4'>
                    <ChartOverTime data={datachartovertime} />
                </Col>
            </Row>
        </Space>
    )
...
export default ChartOverTimePage
