...
function ChartTimeProductionPage() {
    const [datacharttimeproduction, setDataChartTimeProduction] = useState([])
    const loadTimeProduction = () => {
        setDataChartTimeProduction([
            {
                name: 'Total Minutes',
        ...
        <Space direction='vertical' className='w-100' size='small'>
            <Row>
                ...
                <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={24} className='mt-4'>
                    <ChartTimeProduction data={datacharttimeproduction} />
                </Col>
            </Row>
        </Space>
    )
...
export default ChartTimeProductionPage
